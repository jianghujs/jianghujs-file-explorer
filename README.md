...
3. 并且修改数据库配置为自己的数据库, 例如：
   ...
   user: 'root',
   password: '123456',
   database: 'jianghujs_file_explorer'
   ```
4. 启动 npm run dev
...
```sql
# 数据库初始化
create database `jianghujs_file_explorer` default character set utf8mb4 collate utf8mb4_bin;
use jianghujs_file_explorer;
# 运行 sql/init.sql 文件
```
